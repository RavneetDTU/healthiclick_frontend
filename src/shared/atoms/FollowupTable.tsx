          ...
          <tbody>
            {filteredFollowups.map((f) => (
              ...
              >
                  ...
                  <td className="p-2" onClick={() => router.push("/feature/userProfile")}>{f.id}</td>
                  <td className="p-2" onClick={() => router.push("/feature/userProfile")}>{f.name}</td>
                  <td className="p-2" onClick={() => router.push("/feature/userProfile")}>{f.email}</td>
                  <td className="p-2" onClick={() => router.push("/feature/userProfile")}>{f.phone}</td>
                <td className="p-2">
                  <select
