...
export default function ReportSection({ title, description, reports }: ReportSectionProps) {
  ...
  return (
    <section className="bg-white rounded-xl shadow-sm overflow-hidden">
      <div className="px-6 py-5 border-b border-gray-200 dark:border-gray-200">
      ...
      <div className="divide-y divide-gray-100 dark:divide-gray-100">
        {reports.length === 0 ? (
          <div className="p-6 text-center text-gray-500 dark:text-gray-500">No reports available in this category</div>
        ) : (
